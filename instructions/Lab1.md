...
- Move on an implement support for keyboard input (section 2.5 in the book) so that you can add simple interactivity. Like toggling animation, changing speed of animation and/or moving things around.
